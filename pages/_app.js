...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Anshu Jaiswal";
	const description =
		"Hello! I'm Anshu Jaiswal, a passionate Android̉̉ Developer. Welcome to my portfolio";
	const avatar =
		"";
	const url = "https://anshu-jaiswal-myportfolio.vercel.app/";
