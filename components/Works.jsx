    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
         These projects highlight my practical skills and experience, featuring descriptions, code repositories, and live demos. They showcase my ability to tackle complex challenges, adapt to various technologies, and manage projects from inception to completion.
        </motion.p>
      </div>
